...
export default async function AdminReportsPage({
  ...
  const overview = {
    ...
    havaleCollectedTryCents: reports.overview.havaleCollectedTryCents,
    previousHavaleCollectedTryCents: reports.overview.previousHavaleCollectedTryCents,
    havaleTrendPct: reports.overview.havaleTrendPct,
