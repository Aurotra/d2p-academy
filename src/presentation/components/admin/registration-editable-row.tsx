...
export function RegistrationEditableRow({
  ...
  if (isEditing) {
    return (
      <tr className="border-b border-border-surface bg-surface-tint-mixed last:border-0">
  ...
  return (
    <tr className="border-b border-border-surface last:border-0">
      <td className="px-5 py-4 font-semibold text-navy-950">
        ...
        {registration.email ? (
          <p className="mt-1 text-xs font-normal text-subtle">{registration.email}</p>
        ) : null}
      ...
      <td className="px-5 py-4 text-[var(--text-on-surface-soft)]">{registration.phone}</td>
      <td className="px-5 py-4 text-[var(--text-on-surface-soft)]">
        {registration.time_group ? (
          <span className="inline-flex rounded-lg bg-surface-section px-2.5 py-1 text-xs font-bold text-navy-900">
      ...
      <td className="px-5 py-4 text-[var(--text-on-surface-soft)]">{registration.course}</td>
