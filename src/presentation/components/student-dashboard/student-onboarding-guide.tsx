...
export function StudentOnboardingGuide() {
  return (
    <div className="rounded-[2rem] border border-sky-200 bg-gradient-to-br from-sky-50 via-white to-cyan-50 p-6 shadow-sm sm:p-8">
      ...
      <ol className="mt-6 space-y-3 text-sm text-slate-700">
        <li className="flex gap-3 rounded-xl border border-slate-100 bg-white/80 px-4 py-3">
