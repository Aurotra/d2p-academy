...
const baseClasses =
  "inline-flex items-center justify-center rounded-xl text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-surface-base";

const kindClasses: Record<AuthPortalKind, string> = {
  student:
    "bg-accent text-navy-950 shadow-md shadow-accent/25 hover:bg-accent-dark hover:shadow-glow-accent focus-visible:ring-accent/50",
  parent:
