-- D2P Academy | Migration 070
-- 2–4. sınıflar da 5–8 ile aynı ön/son test (F02/F03) prosedürünü kullanır.
...
begin
  ...
  v_requires_surveys := public.requires_d2p_tps_surveys(v_grade);
